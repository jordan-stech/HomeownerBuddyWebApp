...
namespace HOB_WebApp.Controllers
{
    public class MobileUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FName,Lname,Code,address,date")] MobileUsers mobileUsers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FName,Lname,Code,address,date")] MobileUsers mobileUsers)
        {
